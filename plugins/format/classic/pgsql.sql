...
INSERT INTO _format (name, version) VALUES('classic', '14.4');
...
CREATE TABLE Prelude_Service (
 ...
 name VARCHAR(255) NULL,
 port NUMERIC(5) NULL,
 iana_protocol_number INT4 NULL,
