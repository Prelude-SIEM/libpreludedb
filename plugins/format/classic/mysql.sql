...
CREATE TABLE Prelude_CorrelationAlert (
 ident BIGINT UNSIGNED NOT NULL,	# generated by prelude-manager, it identifies a group of correlated alerts
...
CREATE TABLE Prelude_OverflowAlert (
 alert_ident BIGINT UNSIGNED NOT NULL,	# alert_ident of the associated Alert
...
CREATE TABLE Prelude_Analyzer (
 ...
 ident BIGINT UNSIGNED NOT NULL DEFAULT '1', 
...
CREATE TABLE Prelude_Source (
 alert_ident BIGINT UNSIGNED NOT NULL, # Ident of an alert
 ident BIGINT UNSIGNED NOT NULL,   # Ident of the source, GENERATED by prelude manager ; this is a counter of sources for a given alert
...
CREATE TABLE Prelude_Target (
 alert_ident BIGINT UNSIGNED NOT NULL, # Ident of an alert
 ident BIGINT UNSIGNED NOT NULL,   # Ident of the target, GENERATED by prelude manager ; this is a counter of targets for a given alert
...
CREATE TABLE Prelude_FileList ( # This table is only here to have full compliance.
 alert_ident BIGINT UNSIGNED NOT NULL,
 target_ident BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Prelude_FileAccess (
 alert_ident BIGINT UNSIGNED NOT NULL,
 target_ident BIGINT UNSIGNED NOT NULL,
 file_ident BIGINT UNSIGNED NOT NULL,
 path_file VARCHAR(255) NOT NULL,
 name_file VARCHAR(255) NOT NULL,
 userId_ident BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Prelude_Node (
 alert_ident BIGINT UNSIGNED NOT NULL,
 parent_type ENUM('A','H','S','T') NOT NULL DEFAULT 'S', # A=Analyzer T=Target S=Source H=Heartbeat
 parent_ident BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Prelude_Address (
 alert_ident BIGINT UNSIGNED NOT NULL,
 parent_type ENUM('A','H','S','T') NOT NULL DEFAULT 'S', # A=Analyser T=Target S=Source H=Heartbeat
 parent_ident BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Prelude_UserId (
 ...
 parent_type ENUM('S','T') NOT NULL DEFAULT 'S',	# T=Target S=Source 
 parent_ident BIGINT UNSIGNED NOT NULL,
 ident BIGINT UNSIGNED NOT NULL, #generated by prelude manager, this is a counter for one alert and one target (or one source)
...
CREATE TABLE Prelude_Process (
 alert_ident BIGINT UNSIGNED NOT NULL,
 parent_type ENUM('A','H','S','T') NOT NULL DEFAULT 'A', # A=Analyzer T=Target S=Source H=Heartbeat
 parent_ident BIGINT UNSIGNED NOT NULL,
 name VARCHAR(255) NOT NULL,
 pid INTEGER NULL,
...
CREATE TABLE Prelude_ProcessArg (
 alert_ident BIGINT UNSIGNED NOT NULL,
 parent_type ENUM('A','H','S','T') NOT NULL DEFAULT 'A', # A=Analyser T=Target S=Source
 parent_ident BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Prelude_WebService (
 ...
 parent_type ENUM('S','T') NOT NULL DEFAULT 'S', # T=Target S=Source
 parent_ident BIGINT UNSIGNED NOT NULL,
 service_ident BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE Prelude_WebServiceArg (
 alert_ident BIGINT UNSIGNED NOT NULL,
 parent_type ENUM('S','T','A') NOT NULL DEFAULT 'S', # A=Analyser T=Target S=Source
 parent_ident BIGINT UNSIGNED NOT NULL,
 arg VARCHAR(255) NULL, # size problem ?
INDEX (alert_ident,parent_type,parent_ident)
);
